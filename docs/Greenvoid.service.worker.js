...
/** @type {string} */
const CACHE_VERSION = '1748819876|76785877';
/** @type {string} */
const CACHE_PREFIX = 'Greenvoid-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Greenvoid.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Greenvoid.html","Greenvoid.js","Greenvoid.offline.html","Greenvoid.icon.png","Greenvoid.apple-touch-icon.png","Greenvoid.audio.worklet.js","Greenvoid.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Greenvoid.wasm","Greenvoid.pck"];
